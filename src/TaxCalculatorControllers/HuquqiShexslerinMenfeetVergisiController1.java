 ...
 * @author Vafa
 */
public class HuquqiShexslerinMenfeetVergisiController1 extends javax.swing.JFrame {

    /**
     * Creates new form HuquqiShexslerinMenfeetVergisiController
     */
    public HuquqiShexslerinMenfeetVergisiController1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Bələdiyyə mülkiyyətində olan müəssisə və təşkilatların mənfəət vergisi");
        setResizable(false);
...
//                }
            ...
            java.util.logging.Logger.getLogger(HuquqiShexslerinMenfeetVergisiController1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HuquqiShexslerinMenfeetVergisiController1().setVisible(true);
            }
        });
    }
